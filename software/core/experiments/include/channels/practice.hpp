...
#ifndef __channels_practice_hpp__
#define __channels_practice_hpp__
...
int practice::encode(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int practice::decode(const void *buf, int offset, int maxlen)
{
    int pos = 0, thislen;
...
int practice::getEncodedSize() const
{
    return 8 + _getEncodedSizeNoHash();
}

int64_t practice::getHash()
{
    static int64_t hash = static_cast<int64_t>(_computeHash(NULL));
    return hash;
}

const char* practice::getTypeName()
{
    return "practice";
}

int practice::_encodeNoHash(void *buf, int offset, int maxlen) const
{
    int pos = 0, tlen;
...
int practice::_decodeNoHash(const void *buf, int offset, int maxlen)
{
    int pos = 0, tlen;
...
int practice::_getEncodedSizeNoHash() const
{
    int enc_size = 0;
...
uint64_t practice::_computeHash(const __lcm_hash_ptr *)
{
    uint64_t hash = 0x4bcee7bb68e68f7eLL;
