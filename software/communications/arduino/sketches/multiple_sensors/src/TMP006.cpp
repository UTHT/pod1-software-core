...
const char* arr_tmp[2] = {"deg C [Object]", "deg C [Die]"};
t_datasetup datasetup_tmp = {2, arr_tmp};

TMP006::TMP006(uint8_t addr, arduino_t arduino) : Sensor(S_TMP006, arduino, datasetup_tmp, 250){
